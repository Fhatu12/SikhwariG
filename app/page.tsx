        ...
        <Container className="grid gap-8 lg:grid-cols-[1.5fr_1fr] lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">
              We partner with organizations that need practical delivery in strategy execution,
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-[var(--shadow-soft)]">
            ...
            <p className="mt-2 text-sm text-slate-600">
              This release provides the website foundation for corporate information, legal
              disclosures, and contact intake.
            </p>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {["Advisory", "Cybersecurity", "Operations support"].map((item) => (
            <article key={item} className="rounded-xl border border-slate-200 bg-white p-5">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Placeholder content for Slice 1. Detailed offerings will be expanded in upcoming
                releases.
              </p>
            </article>
          ))}
